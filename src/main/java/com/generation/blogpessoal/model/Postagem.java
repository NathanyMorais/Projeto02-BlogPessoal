...
@Entity //usamos essa anotação para indicar ao Spring que estamos criando uma Classe Entidade (Model), que será mapeada como uma tabela em nosso Banco de dados
